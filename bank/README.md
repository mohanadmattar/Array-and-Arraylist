# 5A - Self Exercise/Exploration of Array and ArrayList
**Course:** Pemrograman Berorientasi Objek (PBO - Object-Oriented Programming)  
**Institution:** Informatics Engineering, Universitas Mataram (UNRAM)  
**Lecture Material Reference:** [Eng_PBO_4_ArrayAndArrayList.pdf](file:///c:/Users/mh/Desktop/pbo/Eng_PBO_4_ArrayAndArrayList.pdf) (Pages 26–31)
...
```text
bank/
├── Account.java         # Bank account class (balance, deposit, withdraw) with Arabic comments
├── Customer.java        # Customer class managing Account[] array with Arabic comments
├── Bank.java            # Bank class managing Customer[] array with Arabic comments
├── BankDemo.java        # Main driver with ATM menu & Array/ArrayList exploration
├── BnakDemo.java        # Alias wrapper for BankDemo
└── README.md            # Complete GitHub documentation and guide
```
